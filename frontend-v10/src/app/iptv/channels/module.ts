...
#
#   gencrud: 2021-10-24 19:21:23 version 3.0.685 by user mbertens
*/
...
export const channelsRoute: Route = {
    path: '',
...
*   creating entry point and providing the services for the channels screens and dialogs.
*
...
@NgModule( {
    ...
    imports: [
        ...
        FormsModule,
        ReactiveFormsModule,
        RouterModule.forChild( [ channelsRoute ] ),
        GenCrudModule
    ],
    exports: [
        ScreenChannelComponent,
