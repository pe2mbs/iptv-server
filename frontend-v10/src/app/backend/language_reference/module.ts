    ...
    children: [
        {
            ...
            children: [
                {
                    path: '',
                    component: LanguageReferenceTableComponent,
                    data:
                    {
                        breadcrumb: 'Overview',
                        title:      ''
...
*   creating entry point and providing the services for the language_reference screens and dialogs.
*
...
@NgModule( {
    declarations: [
        DialogLanguageReferenceComponent,
        LanguageReferenceTableComponent
    ],
    entryComponents: [
        DialogLanguageReferenceComponent,
    ],
    providers: [
        LanguageReferenceDataService,
        {
    ...
    imports: [
        ...
        FormsModule,
        ReactiveFormsModule,
        RouterModule.forChild( [ language_referenceRoute ] ),
        GenCrudModule
    ],
    exports: [
        DialogLanguageReferenceComponent,
...
export class LanguageReferenceModule
{
    ...
    static forChild(): ModuleWithProviders<LanguageReferenceModule>
    {
        return { ngModule: LanguageReferenceModule };
    }
}
