...
import { ScreenNewsComponent } from './screen.component';

import { NewsTableComponent } from './table.component';
...
*   creating entry point and providing the services for the news screens and dialogs.
*
