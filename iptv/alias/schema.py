...
class AliasSchema( API.mm.SQLAlchemySchema ):
    """Schema for the alias table, this is generated by the gencrud.py module
    When modifing the file make sure that you remove the table from the configuration.
    """
    IA_ID    = fields.Integer()
    IA_NAME    = fields.String()
    IA_ALIAS    = fields.String()
    IA_INDEX    = fields.Integer()
...
aliassSchema  = AliasSchema( many = True )
