...
class User( API.db.Model, CrudModelMixin ):
    ...
    """
    __field_list__       = ['U_ID', 'U_ACTIVE', 'U_NAME', 'U_ROLE', 'U_HASH_PASSWORD', 'U_MUST_CHANGE', 'U_FIRST_NAME', 'U_MIDDLE_NAME', 'U_LAST_NAME', 'U_EMAIL', 'U_REMARK', 'U_LOCALE', 'U_LISTITEMS', 'U_PROFILE']
    __tablename__        = 'user'
