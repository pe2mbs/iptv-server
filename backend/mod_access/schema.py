...
class ModuleAccessSchema( API.mm.SQLAlchemySchema ):
    """Schema for the mod_access table, this is generated by the gencrud.py module
    When modifing the file make sure that you remove the table from the configuration.
    """
    MA_ID    = fields.Integer()
    MA_MODULE    = fields.String()
    MA_DESCRIPTION    = fields.String()
...
mod_accessSchema   = ModuleAccessSchema()
mod_accesssSchema  = ModuleAccessSchema( many = True )
