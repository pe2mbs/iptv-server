...
class LanguagesSchema( API.mm.SQLAlchemySchema ):
    """Schema for the languages table, this is generated by the gencrud.py module
    When modifing the file make sure that you remove the table from the configuration.
    """
    LA_ID    = fields.Integer()
    LA_LABEL    = fields.String()
    LA_CODE2    = fields.String()
    LA_CODE3    = fields.String()
    LA_COUNTRY_CODE2    = fields.String()
    LA_COUNTRY_CODE3    = fields.String()
...
languagessSchema  = LanguagesSchema( many = True )
